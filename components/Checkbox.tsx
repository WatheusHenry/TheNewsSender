...
export default function App() {
  return (
    <div className="flex gap-4">
      <Checkbox defaultSelected icon={<HeartIcon size={undefined} height={undefined} width={undefined} />}>
        Option
      </Checkbox>
      <Checkbox defaultSelected color="warning" icon={<PlusIcon size={undefined} height={undefined} width={undefined} />}>
        Option
      </Checkbox>
    </div>
  );
